window.__twilightSettings = {
  ...
  "2fa_resend_sms_timeout": 30000,
  "2fa_restricted_country_code": ["RU"],
  "3p_save_oauth_token": [1, true],
  "abrasive_bunny_searching": [1, false],
  ...
  "ads_freeform_tags_deprecation": [0, false],
  ...
  "chmod-bcsvs": true,
  "cht_emote_campaign_active": [0, false],
  ...
  "disco_category_redirect_slugs": ["calabiyau", "strinova", "aether-trading-card-game", "cards-of-eternity-the-wheel-of-time", "project-arc", "pubg-blindspot", "marathon-1", "marathon", "marathon-2025", "marathon", "black-space", "hyper-frenzy"],
  ...
  "modern_lobster_singing": [1, false],
  ...
  "one-tap-streak-update-tracking-sample-rate": 0.1,
  ...
  "sidp_toggle": [0, false],
  "signup_resend_sms_timeout": 30000,
